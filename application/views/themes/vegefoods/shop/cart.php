...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg-3.jpg'); ?>');">
  ...
  <section class="ftco-section ftco-Keranjang Belanja">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><a href="<?php echo site_url('pages/browse'); ?>">Jelajahi Produk Kami</a> dan mulailah berbelanja!</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
