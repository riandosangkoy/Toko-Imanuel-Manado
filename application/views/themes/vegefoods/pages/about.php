...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg-3.jpg'); ?>');">
    <div class="container">
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
          <div class="container">
              <div class="row">
                  <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/logo2.jpg'); ?>);">
                      <a href="https://www.youtube.com/watch?v=__OT__Ag3EU" class="icon popup-vimeo d-flex justify-content-center align-items-center">
            ...
            <div class="pb-md-5">
                <p><?php echo get_settings('store_description'); ?></p>
                          <p><a href="<?php echo site_url('pages/browse'); ?>" class="btn btn-primary">Belanja sekarang!</a></p>
                      </div>
                  </div>
              </div>
          </div>
