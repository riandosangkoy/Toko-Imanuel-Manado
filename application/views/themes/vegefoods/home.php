...
<section id="home-section" class="hero">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Salah Satu Toko Di Kota Timika</h1>
              <h2 class="subheading mb-4">Yang Menjamin Kualitas Berbagai Jenis Beras Dan Pakan Ternak</h2>
            <h2 class="subheading mb-4">Menyediakan Berbagai Jenis Beras Dan Pakan Ternak Dengan Jaminan Berkualitas</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg-3.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Beras Dan Pakan Ternak Berkualitas</h1>
            <h2 class="subheading mb-4">Beras Dan Pakan Ternak Langsung dari Distributor</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg-1.jpg'); ?>);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Hanya Menjual Beras Dan Pakan Ternak yang Berkualitas</h1>
            <h2 class="subheading mb-4">Beras Dan Pakan Ternak Langsung dari Distributor</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Potongan Harga</h3>
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Dari Distributor Terpercaya</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
  ...
  <section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/bg-2.jpg'); ?>);">
  <div class="container">
